...
export const tools: Tool[] = [
  ...
  },
  {
    slug: "prompt-linter",
    name: "Prompt Linter",
    description: "Lint prompts for ambiguity, missing constraints, and conflicting instructions.",
    category: "ai",
    icon: "PLT",
  },
  {
    ...
    description: "Validate AI JSON outputs against schema before downstream parsing or automation.",
    category: "ai",
    icon: "JOG",
  },
  {
  ...
  },
  {
    ...
    description: "Simulate chunk size and overlap settings to tune retrieval-ready document chunking.",
    category: "ai",
    icon: "RAG",
  },
  {
