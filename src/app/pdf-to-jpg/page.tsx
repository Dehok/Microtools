...
export default function PdfToJpgPage() {
  ...
  const downloadPage = (page: RenderedPage) => {
    ...
    link.href = page.url;
    link.download = `${nameWithoutExt}-page-${page.pageNumber}.jpg`;
    link.click();
  };
  ...
  return (
    <ToolLayout
      ...
      description="Convert each PDF page to a JPG image in your browser with quality and resolution controls."
      relatedTools={["pdf-to-text", "image-compressor", "pdf-split"]}
    >
      ...
      >
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          Tip: set quality and scale before uploading for the final output.
        </p>
        <input
          ref={fileInputRef}
          type="file"
      ...
      <div className="mt-12 space-y-6 border-t border-gray-200 pt-8 text-sm leading-relaxed text-gray-600 dark:border-gray-700 dark:text-gray-400">
        ...
        <p>
          PDF to JPG Converter renders each page in your browser and exports JPG files with your selected quality.
          Nothing is uploaded, so documents stay on your device.
        </p>
        ...
        <div className="space-y-4">
          <details className="group">
            <summary className="cursor-pointer font-medium text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
              Is the output quality lossless?
            </summary>
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              JPG uses lossy compression. For best results use higher quality and higher render scale.
            </p>
          </details>
          <details className="group">
            <summary className="cursor-pointer font-medium text-gray-700 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              No. All PDF rendering and JPG conversion run locally in your browser.
            </p>
          </details>
        </div>
      </div>
