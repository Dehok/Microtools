  ...
  return (
    ...
    >
      ...
      <div className="mt-12 space-y-6 text-gray-600 dark:text-gray-400 text-sm leading-relaxed border-t border-gray-200 dark:border-gray-700 pt-8">
        ...
        <p>
          The Random Number Generator is a free online tool available on CodeUtilo. Generate random numbers within a custom range with various options. All processing happens directly in your browser — no data is ever sent to any server, ensuring your privacy and security. No signup or installation is required.
        </p>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong className="text-gray-700 dark:text-gray-300">Browser-Based Processing</strong> — All random number generator operations run locally in your browser using JavaScript. Your data never leaves your device.
          </li>
          <li>
            <strong className="text-gray-700 dark:text-gray-300">Instant Results</strong> — Get results immediately as you type or paste your input. No waiting for server responses or page reloads.
          </li>
          <li>
            <strong className="text-gray-700 dark:text-gray-300">Free &amp; No Signup</strong> — Use the random number generator as many times as you need without creating an account or paying anything.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>Using the random number generator for day-to-day development tasks</li>
        ...
        <p>
          Enter your input in the text area provided and the random number generator will process it instantly. Use the Copy button to copy the result to your clipboard. All operations are performed locally in your browser — no data is transmitted to any server.
        </p>
        ...
        <div className="space-y-4">
          <details className="group">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              Yes, the Random Number Generator is completely free with no usage limits. There is no signup or registration required. You can use it as many times as you need.
            </p>
          </details>
          <details className="group">
            <summary className="cursor-pointer font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
          ...
          <details className="group">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              Yes. The Random Number Generator is fully responsive and works on smartphones, tablets, and desktop computers. You can use it from any modern browser on any device.
            </p>
          </details>
          <details className="group">
            <summary className="cursor-pointer font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              No. The Random Number Generator runs entirely in your web browser. There is nothing to download or install. Just open the page and start using it immediately.
            </p>
          </details>
        </div>
</div>
