...
export default function WebPToPngPage() {
  ...
  const download = (item: ConvertedImage) => {
    ...
    link.download = item.original.name.replace(/\.webp$/i, "") + ".png";
  ...
  return (
    <ToolLayout
      ...
      description="Convert WebP images to PNG directly in your browser. No upload, no signup, no data collection."
    ...
    >
      ...
      <div className="mt-12 space-y-6 border-t border-gray-200 dark:border-gray-700 pt-8 text-sm leading-relaxed text-gray-600 dark:text-gray-400">
        ...
        <p>
          WebP to PNG conversion runs locally in your browser with the Canvas API. Your files are never uploaded to
          any server.
        </p>
      </div>
    </ToolLayout>
