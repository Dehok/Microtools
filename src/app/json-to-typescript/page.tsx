        ...
        <div className="space-y-4">
          <details className="group">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              Yes, the JSON to TypeScript is completely free with no usage limits. There is no signup or registration required. You can use it as many times as you need.
            </p>
          </details>
          <details className="group">
            <summary className="cursor-pointer font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
          ...
          <details className="group">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              Yes. The JSON to TypeScript is fully responsive and works on smartphones, tablets, and desktop computers. You can use it from any modern browser on any device.
            </p>
          </details>
          <details className="group">
            <summary className="cursor-pointer font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
            ...
            <p className="mt-2 pl-4 text-gray-600 dark:text-gray-400">
              No. The JSON to TypeScript runs entirely in your web browser. There is nothing to download or install. Just open the page and start using it immediately.
            </p>
          </details>
        </div>
</div>
