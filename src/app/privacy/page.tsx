  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-4 text-gray-600">
        ...
        <h2 className="mt-6 text-xl font-semibold text-gray-900">4. Third-Party Advertising</h2>
        <p>
        ...
        <h2 className="mt-6 text-xl font-semibold text-gray-900">5. Analytics</h2>
        <p>
        ...
        <h2 className="mt-6 text-xl font-semibold text-gray-900">6. External Links</h2>
        <p>
          Our website may contain links to external sites. We are not responsible for
          the privacy practices of other websites.
        </p>

        <h2 className="mt-6 text-xl font-semibold text-gray-900">7. Children&apos;s Privacy</h2>
        <p>
          Our website is not directed at children under 13. We do not knowingly collect
          information from children.
        </p>

        <h2 className="mt-6 text-xl font-semibold text-gray-900">8. Changes</h2>
        <p>
