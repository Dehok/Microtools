...
export default function Home() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:py-12">
      ...
      <section className="mb-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {topCategoryRows.map((row) => (
          <Link
            ...
            className="rounded-2xl border border-gray-200 bg-white p-5 text-center shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-900 dark:hover:border-blue-700"
          >
      ...
      <ToolExplorer compact className="mb-10 md:hidden" />
