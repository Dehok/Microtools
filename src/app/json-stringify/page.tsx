  ...
  return (
    ...
    >
      <div className="mb-4 flex gap-2">
        <button
          ...
          className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
            mode === "parse" ? "bg-blue-600 text-white" : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50"
          }`}
        >
          Parse (unescape)
        </button>
        <button
          ...
          className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
            mode === "stringify" ? "bg-blue-600 text-white" : "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50"
          }`}
        >
          Stringify (escape)
        </button>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <textarea
            ...
            className="h-56 w-full rounded-lg border border-gray-300 bg-gray-50 p-3 font-mono text-xs focus:border-blue-500 focus:outline-none"
            spellCheck={false}
          />
        </div>
        <div>
      ...
      <div className="mt-8 border-t border-gray-200 pt-6 text-sm text-gray-600">
        <h2 className="mb-3 text-lg font-semibold text-gray-900">What is JSON.stringify?</h2>
        <p className="mb-3">
        ...
        <h2 className="mb-3 text-lg font-semibold text-gray-900">Common Use Cases</h2>
        <p>
