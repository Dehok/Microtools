  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="mb-4 h-24 w-full rounded-lg border border-gray-300 bg-gray-50 p-3 text-sm focus:border-blue-500 focus:outline-none"
        spellCheck={false}
      />
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-3">
          <div className="flex items-center justify-between mb-1">
            <span className="text-sm font-semibold text-gray-700">ROT13</span>
            <CopyButton text={results.rot13} />
          </div>
          <div className="font-mono text-sm text-gray-900 break-all">{results.rot13}</div>
        </div>

        {/* ROT47 */}
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-3">
          <div className="flex items-center justify-between mb-1">
            <span className="text-sm font-semibold text-gray-700">ROT47</span>
            <CopyButton text={results.rot47} />
          </div>
          <div className="font-mono text-sm text-gray-900 break-all">{results.rot47}</div>
        </div>
        ...
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-3">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold text-blue-700">Caesar Shift</span>
              <input
                type="number"
                min="1"
                max="25"
                ...
                className="w-16 rounded border border-blue-300 bg-white px-2 py-0.5 text-center text-sm"
              />
            </div>
      ...
      {/* Decode hint */}
      <div className="mt-4 rounded-lg border border-yellow-200 bg-yellow-50 px-4 py-2 text-sm text-yellow-700">
      ...
      <div className="mt-8 border-t border-gray-200 pt-6 text-sm text-gray-600">
        <h2 className="mb-3 text-lg font-semibold text-gray-900">What is ROT13?</h2>
        <p className="mb-3">
        ...
        <h2 className="mb-3 text-lg font-semibold text-gray-900">ROT13 vs ROT47 vs Caesar Cipher</h2>
        <p>
