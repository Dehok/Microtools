...
function charCountColor(len: number, min: number, max: number): string {
  ...
  if (len <= min) return "text-green-600";
    ...
    >
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <pre className="max-h-96 overflow-auto rounded-lg border border-gray-200 bg-gray-50 p-3 font-mono text-[11px] whitespace-pre-wrap">
            {generatedTags}
          </pre>

          {/* Quick tips */}
          <div className="mt-4 rounded-lg border border-blue-100 bg-blue-50 p-3">
            <h3 className="mb-1 text-xs font-semibold text-blue-800">
              Quick Tips
            </h3>
      ...
      <div className="mt-8 border-t border-gray-200 pt-6 text-sm text-gray-600">
        ...
        <p className="mb-3">
          ...
          <code className="rounded bg-gray-100 px-1 text-xs">&lt;head&gt;</code>{" "}
