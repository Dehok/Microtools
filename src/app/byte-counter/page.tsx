  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="mb-4 h-32 w-full rounded-lg border border-gray-300 bg-gray-50 p-3 text-sm focus:border-blue-500 focus:outline-none"
        spellCheck={false}
      />
        ...
        <>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={row.label} className="flex justify-between rounded-lg border border-gray-100 bg-gray-50 px-4 py-2 text-sm">
                <span className="text-gray-500">{row.label}</span>
                <span className="font-medium text-gray-900 font-mono">{row.value}</span>
              </div>
            ))}
          </div>
          ...
          <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
            <h3 className="mb-2 text-sm font-semibold text-gray-900">UTF-8 Byte Breakdown</h3>
            <div className="grid grid-cols-2 gap-2 text-sm sm:grid-cols-4">
              <div className="text-center">
                <div className="font-bold text-gray-900">{stats.byteBreakdown.one}</div>
                <div className="text-xs text-gray-500">1-byte (ASCII)</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-gray-900">{stats.byteBreakdown.two}</div>
                <div className="text-xs text-gray-500">2-byte</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-gray-900">{stats.byteBreakdown.three}</div>
                <div className="text-xs text-gray-500">3-byte</div>
              </div>
              <div className="text-center">
                <div className="font-bold text-gray-900">{stats.byteBreakdown.four}</div>
                <div className="text-xs text-gray-500">4-byte (emoji)</div>
              </div>
            </div>
          </div>
        </>
      ...
      <div className="mt-8 border-t border-gray-200 pt-6 text-sm text-gray-600">
        <h2 className="mb-3 text-lg font-semibold text-gray-900">Why Count Bytes?</h2>
        <p className="mb-3">
        ...
        <h2 className="mb-3 text-lg font-semibold text-gray-900">UTF-8 vs UTF-16</h2>
        <p>
